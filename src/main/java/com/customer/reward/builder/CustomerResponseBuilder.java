...
public class CustomerResponseBuilder {
	...
	public List<TransacationPeriod> buildCustomerRespone() {
		
		List<TransacationPeriod> transacationPeriods = new ArrayList<TransacationPeriod>();
		TransacationPeriod transacationPeriod1 = new TransacationPeriod();
		...
		TransacationPeriod transacationPeriod2 = new TransacationPeriod();
		...
		TransacationPeriod transacationPeriod3 = new TransacationPeriod();
	...
	private void calculateRewards(TransacationPeriod transacationPeriod) {
